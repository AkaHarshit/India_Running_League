...
const tierColors = {
  RoadWarrior: "bg-amber-100 text-amber-800 border-amber-300",
  TrailBlazer: "bg-emerald-100 text-emerald-800 border-emerald-300",
  MarathonKing: "bg-purple-100 text-purple-800 border-purple-300",
};
          ...
          <div className="mt-3">
            <span
              className={`badge border ${
                tierColors[tier] || "bg-gray-100 text-gray-800 border-gray-300"
              }`}
            >
